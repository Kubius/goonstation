...
/obj/landmark/engine_room/menhir
#ifdef IN_MAP_EDITOR
	icon = 'icons/effects/mapeditor/engine_room_menhir.dmi'
	icon_state = "23x26engine_room"
#else
	icon = null
	icon_state = null
#endif

...
//Setting to ASS_JAM allows it during Ass Jam (currently disabled) and setting to ALTMAP allows selection on server 2 in addition to Ass Jam.
var/global/list/mapNames = list(
	...
	"Donut 2 (ALTERNATE)" = 		list("id" = "DONUT2", 		"settings" = "donut2",			"playerPickable" = ALTMAP,		"MaxPlayersAllowed" = 80),
	...
	"Ozymandias (ALTERNATE)" = 	list("id" = "OZYMANDIAS", "settings" = "ozymandias", 	"playerPickable" = ALTMAP, 	"MinPlayersAllowed" = 70),
	//"Bellerophon Fleet" = list("id" = "FLEET", "settings" = "fleet", "playerPickable" = ASS_JAM),
	"Icarus (ALTERNATE)" = 			list("id" = "ICARUS",		"settings" = "icarus",				"playerPickable" = ALTMAP,		"MaxPlayersAllowed" = 80),
